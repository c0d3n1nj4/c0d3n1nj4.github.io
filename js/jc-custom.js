	...
	/************** Contact Form *********************/
		$(".contact-form #submit").click(function(e) { 
			...
			if(proceed===true) {
				...
				var postDataJson = {'userName':user_name, 'userEmail':user_email, 'userSubject':user_subject, 'userMessage':user_message};
					
				//Ajax post data to server
				$.post('contact.php', postDataJson, function(data){  
					//load success massage in #result div element, with slide effect.       
					$("#result").hide().html('<div class="success">'+data.statusText+'</div>').slideDown();
